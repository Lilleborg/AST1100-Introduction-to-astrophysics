...
for j in range(n-1):    #Itterating time steps
    ...
    rvec = rvec + vvec*dt
plot(pos,N,n) #included when testing particle movement
...
nr_boxes = v_esc * 1.6 /(dv*20*60/time) #Nr box to reach v_esc within 20 min
...
#mys.massNeededCheck(nr_boxes,v_esc,dp_hole/time,esc_part/time,m_satelite)
